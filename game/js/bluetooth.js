class BluetoothController {
    ...
    connect() {
        return (
            this.deviceCache ? Promise.resolve(this.deviceCache) :
    ...
    requestBluetoothDevice () {
        ...
        return navigator.bluetooth.requestDevice({
            ...
            then(device => {
                ...
                this.deviceCache.addEventListener('gattserverdisconnected', (e) => this.handleDisconnection(e, self));
    ...
    startNotifications(characteristic) {
        ...
        return characteristic.startNotifications().
            then(() => {
                ...
                let self = this;
                characteristic.addEventListener('characteristicvaluechanged', (event) => this.handleCharacteristicValueChanged(event, self));
            });
    }
    ...
    // Output to Terminal
    log(data, type = '') {
        this.terminalContainer.insertAdjacentHTML('beforeend',
    ...
    disconnect() {
        if (this.deviceCache) {
            ...
            this.deviceCache.removeEventListener('gattserverdisconnected', this.handleDisconnection);
        ...
        if (this.characteristicCache) {
            this.characteristicCache.removeEventListener('characteristicvaluechanged', (event) => this.handleCharacteristicValueChanged(event, self));
            this.characteristicCache = null;
        }
    }
